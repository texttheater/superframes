...
\ex. \a. \dep{The cook_xcau *deboned* the fish_pwhir}
...
\ex. \a. \dep{The knife_xcau *cut* the butter_pcpd}
     \b. \dep{Kim_xcau *cut* the butter_pcpd with the knife_ins}

\ex. \a. \dep{The price_pcpd is *high*}
     \b. \dep{The butter_pcpd is *high* in price_att}
...
\b. \label{ex:help-ternary} \dep{Kim_xcau *helped* Sandy_pcpd clean_pcpr the dishes}
...
\ref{ex:help-binary} remains consistent with \ref{ex:help-ternary}.
...
\b. \label{ex:help-binary} \dep{Kim_xcau *helped* Sandy_pcpd}
...
\ex. \a. \dep{a *package* that was too heavy_pcp}
