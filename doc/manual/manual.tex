...
\begin{table}
    \resizebox{\textwidth}{!}{
        \begin{NiceTabular}{lllllll}
            ...
            \boro\fr{KIND} & & \rl{has-kind} & \rl{kind} & & & \ref{sec:KIND} \\
...
\rl{has-kind} is an entity that is of kind \rl{kind}. Use \rl{m-kind} rather
than \fr{m-quality} when the meaning of a modifier is specific to the class of
the modifiee.

\ex.\dep{colored_m-kind *pencil#CLASS*}

\ex.\dep{*boa#CLASS* constrictor_m-kind}

\ex.\dep{such_m-kind *knowledge#MESSAGE*}
