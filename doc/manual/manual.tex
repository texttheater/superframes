...
% This seems to work:
\immediate\write18{python3 -c 'print("Hello \string\\string$\string\\string$\string\\string$!")' > exec.tex}
\input{exec}

% This doesn't - why??
%\immediate\write18{python3 dep.py The cost is \string\\string$ 10 per item_asg-of > exec.tex}
%\input{exec}
%\dep{}
