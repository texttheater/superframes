...
\begin{table}
    \resizebox{\textwidth}{!}{
        \begin{NiceTabular}{llllllr}
            ...
            \emoji{link} \fr{SITUATION} & \rl{initial-situator} & \rl{situated} & \rl{situator} & \rl{transitory-situator} & \rl{target-situator} & \ref{sec:SITUATION} \\

            \Sub\emoji{fork-and-knife} \fr{ACCOMPANIMENT} & & \rl{accompanied} & \rl{accompanier} & & & \ref{sec:ACCOMPANIMENT} \\
            \SubSub\emoji{paintbrush} \fr{DEPICTIVE} & & \rl{has-depictive} & \rl{depictive} & & & \ref{sec:DEPICTIVE} \\

            \Sub\emoji{woman-dancing} \fr{ACTIVITY} & & \rl{is-active} & \rl{activity} & & & \ref{sec:ACTIVITY} \\
            ...
            \Sub\emoji{deciduous-tree} \fr{CLASS} & \rl{initial-class} & \rl{has-class} & \rl{class} & & \rl{target-class} & \ref{sec:CLASS} \\
            ...
            \Sub\emoji{sparkles} \fr{EXISTENCE} & & & \rl{exists} & & & \ref{sec:EXISTENCE} \\
            ...
            \Sub\emoji{eye} \fr{EXPERIENCE} & \rl{initial-experienced} & \rl{experiencer} & \rl{experienced} & \rl{transitory-experienced} & \rl{target-experienced} & \ref{sec:EXPERIENCE} \\
            ...
            \Sub\emoji{passport-control} \fr{IDENTIFICATION} & & \rl{identified} & \rl{identifier} & & & \ref{sec:IDENTIFICATION} \\
            ...
            \SubSub\emoji{t-shirt} \fr{WRAPPING-WEARING} & & \rl{worn} & \rl{wearer} & & & \ref{sec:WRAPPING-WEARING} \\

            \Sub\emoji{hammer} \fr{MEANS} & & \rl{has-means} & \rl{means} & & & \ref{sec:MEANS} \\

            \Sub\emoji{left-speech-bubble} \fr{MESSAGE} & & \rl{topic} & \rl{content} & & & \ref{sec:MESSAGE} \\
            ...
            \Sub\emoji{red-apple} \fr{QUALITY} & & \rl{has-quality} & \rl{quality} & & & \ref{sec:QUALITY} \\

            \Sub\emoji{abacus} \fr{QUANTITY} & & \rl{has-quantity} & \rl{quantity} & & & \ref{sec:QUANTITY} \\

            \Sub\emoji{1st-place-medal} \fr{RANK} & & \rl{has-rank} & \rl{rank} & & & \ref{sec:RANK} \\
            ...
            \Sub\emoji{alarm-clock} \fr{TIME} & & \rl{has-time} & \rl{time} & & & \ref{sec:TIME} \\
...
This is the most generic superframe: something (\rl{situated}) is related to
...
situated. In more specific superframes, the situated:situator relation takes
...
This generic superframe is useful in cases where the type of relation is not specified further.

\ex.\dep{*Yes#SITUATION*}

\ex.\dep{*No#SITUATION-NEG*}

\ex.\dep{*transition#SITUATION-CHANGE* of the account_situated to a new government_target-situator}
