...
\begin{table}
    \resizebox{\textwidth}{!}{
        \begin{NiceTabular}{lllllll}
            ...
            \emoji{red-square} \fr{EVENTUALITY} & & & & & & \ref{sec:SUPERFRAME} \\
...
\subsection{Argument Structure and Frame Choice}

\subsubsection{Prefer Core over Non-core Arguments}
...
\subsubsection{Arguments Determine Frames}
...
\subsubsection{A Participant whose Syntactic Argument Position is Occupied Should Not Be Treated like an Implicit Argument}
...
\subsubsection{When in Doubt, Treat Different Syntactic Frames of the Same Predicate Consistently}
...
\subsubsection{However, Different Senses of a Predicate Can Have Different Arguments and Therefore Different Superframes}
...
\subsubsection{Look Up Unfamiliar Words in a Dictionary}
...
\subsubsection{Symmetric Argument Pairs}
...
\subsubsection{When to Use \fr{SCENE}}
...
\subsubsection{Aspect Annotation is wrt. the Superframe, Not the Predicate}
...
\subsection{Construction-specific Guidelines}

\subsubsection{Participant Nouns}
...
\subsubsection{Pronouns with Arguments}
...
\subsubsection{Nominal Copula Constructions}
