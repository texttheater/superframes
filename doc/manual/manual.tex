...
\begin{table}
    \resizebox{\textwidth}{!}{
        \begin{NiceTabular}{lllllll}
            ...
            \fr{ORG-ROLE} & \rl{initial-org} & \rl{has-org-role} & \rl{org} & & \rl{target-org} & \ref{sec:ORG-ROLE} \\
...
\todo[inline]{rethink evaluatives}
...
\ex.\a.\label{ex:chase1}\dep{Kim_x-accompanier *chased#UNACHORED-MOTION* Sandy_has-location around the block_transitory-location}
    \b.\label{ex:chase2}\dep{Kim_x-accompanier *chased#UNACHORED-MOTION* after Sandy_has-location}
