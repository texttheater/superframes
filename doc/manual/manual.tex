...
\ex.\dep{Kim *never#TIME-NEG* smokes}
...
\ex.\dep{*Nothing#IDENTIFICATION-NEG* about him_m-whole suggested a child}
...
Use \fr{MESSAGE-INIT} (\fr{MESSAGE-DEINIT}, \fr{MESSAGE-INIT-NEG}) for
