...
Accordingly, roles with prefix \rl{target-}, \rl{initial-}, or \rl{transitory-} mark
...
When the object is a work of art, frame it as \fr{TRANSFORMATION-CREATION} instead:

\ex.\dep{Kim_x-sender *drew#TRANSFORMATION-CREATION* a picture_created}
...
\ex.\dep{Kim_x-sender *taught#MESSAGE* Sandy_x-experiencer Spanish_topic}

\ex.\dep{Sandy_x-experiencer is a *professor#MESSAGE* of linguistics_topic}

\ex.\dep{Kim_x-experiencer *measured#MESSAGE* the elasticity_topic}
...
\ex.\dep{Kim_x-initial-experiencer *forgot#MESSAGE* everything they knew_content}
