...
\ex.
\a.\label{ex:berge}\dep{Ich_x-experiencer__x-has-location *will#MESSAGE* in die **Berge#CLASS**}
...
In \label{ex:berge} and \label{ex:office}, We are forced to give \emph{Berge}
and \emph{office} an \rl{x-has-location} role, which is not part of the frame
...
\fr{LOCATION-NEG}, respectively. In \label{ex:miles}, there is an even more
