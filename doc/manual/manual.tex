...
\ex.\dep{Kim_x-accompanier *chased#UNANCHORED-MOTION* Sandy_has-location around the block_transitory-location}
...
\ex.\dep{Kim_x-causer>>x-sender *shook#UNANCHORED-MOTION>>MESSAGE* their head_has-location>>x-noncomp no_x-sent>>content}
...
\ex.\dep{*eat#INGESTION* up_x-quantity the cookies_ingested} (implies \emph{eat} the cookies)
