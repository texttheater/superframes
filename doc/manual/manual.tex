...
The superframe to assign to such dependents is either \fr{NONCOMP}, unless an
argument of the whole predicate syntactically attaches to it. In that case,
label it the same as the top predicate:
