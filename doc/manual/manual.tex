...
\ex.\dep{Es_x-identified sind vor allem_m-mode die *Frauen#CLASS*}
...
\ex.\dep{Kim_has-location **fliegt#LOCATION-INIT** *hoch#LOCATION-INIT*__target-location}
...
\ex.\dep{I_has-state *jumped#STATE-CHANGE* to my_has-state **feet#STATE-CHANGE**_x-noncomp}
...
\ex.\dep{Kim_x-whole 's *leg#PART-WHOLE*}
