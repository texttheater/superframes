...
\b. \dep{The war_xcau *caused* a famine_pcpr}
...
\ex. \a. \dep{The wound_pcpd *began* to heal_pcpr}
...
\ex. \a. \dep{Kim_xcau *let* Sandy_pcpd join_pcpr}
     \b. \dep{Kim_xcau *made* Sandy_pcpd join_pcpr}
     \b. \dep{Kim_xcau *allowed* Sandy_pcpd to join_pcpr}

\subsubsection{Prevention}

\ex. \a. \dep{Kim_xcau *kept* Sandy_pcpd from joining_pcpr}
     \b. \dep{Swift action_xcau *prevented* an outbreak_pcpr}
     \b. \dep{Kim_pcpd *refrained* from going_pcpr}
...
\ex.
\a. \dep{a *package* that was heavy_pcp:pcpd}
\b. \dep{a heavy_pcp:pcpd *package*}
...
\b. \dep{Is that Peter_pcp 's *chair* ?}
...
\ex.
\a. \dep{the third_pcp:prcd *man*}
\b. \dep{I_socd will *join* the club_socr if they ask_prc me}

\subsubsection{Argument Examples}

\ex.
\a. \dep{Form_prcd *follows* function_prcr}
\b. \dep{Cook_prcd is Jobs_prcr ' *successor*}
...
\ex.
\a. \dep{Wheat_pwhr *contains* gluten_pwhd}
...
\ex.
\a. \dep{Kim_pcpd *slept* naked_dpc}
...
\ex.
\a. \dep{Kim_xcau *hammered* the metal_pcpd flat_rsr}
