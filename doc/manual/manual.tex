...
\ex. \a. \label{ex:chase-caused} \dep{Kim_xacc *chased* Sandy_locd around the block_locmr}
...
\b. \dep{Kim_locd *cycled* to Rome_locr with Sandy_acc}
\b. \dep{Kim_xacc *chased* after Sandy_locd}
...
\textsf{scnr} is the quantity, degree, or extent of \textsf{scnd}.
...
\ex.
\a. \dep{Die Piroggen_scnd waren Maria_xben zu dunkel_scnr *geraten*}
\b. \dep{Kim_xcau is *doing* it_scnr for Sandy_ben}
...
\b. \dep{Kim_accr *accompanied* Sandy_accd on the piano_ctx (?)}
...
Entity that perceives scene, or that a message is addressed to.
...
\b. \dep{Wie_mnr *kommst* du_xrcp darauf_exp , ich hätte_msgr etwas damit zu tun?}
