...
\ex.
\a. \label{ex:chase-caused} \dep{Kim_xanc *chased* Sandy_locd around the block_locmr}
...
The \textsf{sucd} follows the \textsf{locr}, e.g., temporally, logically, by
...
\ex.
\a. \dep{Kim_xsnd is *singing* for Sandy_ben}
...
\ex.
\a. \dep{Kim_locd *went* out despite the rain_cnc}
\b. \dep{Kim_locd *came* although Sandy had told_cnc them not to}
...
\ex.
\a. \dep{I_socd will *join* the club_socr if they ask_cnd me}
\b. \dep{The start date_cndd is *contingent* on their approval_cndr}
...
\ex.
\a. \dep{Man_locd durfte das Gelände_locr nur_dim unter Aufsicht_ctx *betreten*}
...
Entity that perceives or experiences a scene, or that a message is addressed to.
...
\b. \dep{Emily_xsnd *delivered* Carlos ' message_msgr to Nianwen to Kilian_xrcp}
...
\ex.
\a. \dep{Kim_locd *cycled* to Rome_locr with Sandy_anc}
\b. \dep{Kim_locd *danced* with Sandy_xanc}
\b. \dep{Kim_xanc *chased* after Sandy_locd}
\b. \dep{Kim_xanc *accompanied* Sandy_xsnd on the piano_xmns}
...
\b. \dep{It_cpd is *raining*}
\b. \dep{There_cpd was a *famine*}
