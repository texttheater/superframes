...
\b. \dep{Die Qualität_caud ist der Motivation_caur *geschuldet*}
...
In concessive contexts, the range is what happens admittedly, and the domain is
what happens nevertheless:

\ex.
\a. \dep{Kim_locd *went* out despite the rain_cmp}
\b. \dep{It *rained*, but Kim went_cmp-of out}
\b. \dep{Kim_xsnd *sent* Sandy_xrcp a letter_msgr , but it never arrived_cmp-of}
\b. \dep{Kim_locd *came* although Sandy had told_cmp them not to}

\textsf{cmp} is also used to compare non-scene entities:
...
\b. \dep{Kim_cmpd *ran* afoul_cpd of Fielding 's constraints_cmpr}
...
\ex.
\a. \dep{Kim_locd__pssr *went* to town_locr to **buy**_xpl food}
\b. \dep{I_xsnd am *stressing* this_msgd because it's important_xpl}
