...
\begin{table}
    \resizebox{\textwidth}{!}{
        \begin{NiceTabular}{llllllr}
            ...
            \Sub\emoji{sparkles} \fr{EXISTENCE} & initial-exists & material & \rl{exists} & & target-exists & \ref{sec:EXISTENCE} \\
...
\ex.\dep{Kim_x-causer *saved#SITUATION-PREVENTION* Sandy_situator from the dragon_target-situator}
...
\ex.\dep{they_situated *need#SITUATION-NECESSITY* six months_situator for digestion_x-purpose}
...
\fr{-CHANGE}/\fr{-INIT}, so usually activities in terms of Vendler.
