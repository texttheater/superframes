...
as in verbal idioms, weather verbs, existential \emph{there}, names, or other
fixed expressions. (Light verbs, on the other hand, are treated with
\fr{SCENE}, see Section~\ref{sec:SCENE}.)
...
\newpage\subsection{Ambiguity between Static and Dynamic? Prefer Dynamic?}
