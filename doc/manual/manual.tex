...
If annotate a literal and a figurative meaning, only the literal meaning need
be considered in the annotation of the \rl{x-noncomp} dependent:
...
Bound pronouns that are part of multiword expressions should get the same role
as their antecedent:
