...
\ex. \a. \dep{Kim_locd *lives* in Boston_locr}
         \dep{The *hat* in the box_loc}

\subsubsection{Motion Events}
...
\subsubsection{Motion Activities}

\ex. \a. \dep{Kim_locd is *running*}
         \dep{Kim_locd is *dancing* around the room_locmr with Sandy_xanc}
...
\ex. \a. \dep{Kim_locr is *wearing* a shirt_locd}
     ...
     \b. \dep{Kim_locir *took* off their glasses}
...
\ex. \a. \dep{Kim_xsnd *curtseyed* to the Queen_xrcp}
     \b. \dep{Kim_xsnd *shook* their head_nuc no_msgr}
...
\ex. \a. \dep{Kim_scnd *partied*}
     ...
     \b. \dep{Kim_scnd *had* sex_nuc with Sandy_xanc}
...
\ex. \a. \dep{Kim_scnd *took* a bath_scnr}
