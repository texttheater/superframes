...
\ex.\dep{Kim_x-experiencer **probably#SCENE-POSSIBILITY**_m-scene *knows#MESSAGE*__scene that_content}

%\ex.\dep{That_has-quality 's really_m-mode *great#QUALITY*}

\ex.\dep{Kim_has-location is **not#SCENE-NEG**_m-scene *here#LOCATION*__scene}
