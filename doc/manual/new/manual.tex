...
\begin{table}
    \resizebox{\textwidth}{!}{
        \begin{tabular}{llllll}
            ...
            \fr{CLASS} & & \rl{has-class} & \rl{class} & & \ref{sec:CLASS} \\
            ...
            \fr{STATE} & & \rl{has-state} & \rl{state} & & \ref{sec:STATE} \\
            ...
            %\fr{MESSAGE-HABIT} & & \rl{topic} & \rl{message} & & \ref{sec:MESSAGE-HABIT} \\
...
\ex.\dep{Change_target-scene is *needed#SCENE-NECESSITY*}

\ex.\dep{Change_target-scene is *possibility#SCENE-POSSIBILITY*}
